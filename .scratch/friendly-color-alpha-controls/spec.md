...
- `.scratch/color-dialog-rejection-semantics/spec.md`
...
4. Keep this work separate from rejection semantics in `.scratch/color-dialog-rejection-semantics/spec.md` unless one focused change safely resolves both.
