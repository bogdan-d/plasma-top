...
2. Test clean install, service enable/start, applet discovery, runtime publication, stop/start, and login restart.
3. Test upgrade from a prior native package and a legacy Python-layout package if such an artifact remains available.
